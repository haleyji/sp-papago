...
<body>
	...
	<div id="container-wrap">
		...
		<select id="target" class="lang-target" aria-label="번역 언어">
			...
			<input type="text" id="rDiv" readonly >
		</div>
	</div>
		...
		function doTranslate(){
			var conf = {
				...
				callback : function(res) {
					...
					console.log(res);
					document.querySelector('#rDiv').value = res.result.translatedText;
				}
			}
			...
			var param = {
				source : document.querySelector('#source').option.value,
				target : document.querySelector('#target').option.value,
